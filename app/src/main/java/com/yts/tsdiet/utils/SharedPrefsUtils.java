...
public class SharedPrefsUtils {
    ...
    public static float getFloatPreference(Context context, String key, float defaultValue) {              ///인트값 불러오기 위한 함수
    ...
    public static boolean setFloatPreference(Context context, String key, float value) {                ///인트값 설정하기 위한 함수
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(context);
        if (preferences != null) {
            SharedPreferences.Editor editor = preferences.edit();
